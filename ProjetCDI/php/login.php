...
<div class="login">
   <div class="text-center"> <h1>Connecte-toi!</h1>
    <form method="post" class="needs-validation">

    <div class="form-group was-validated">
        <label class="form-label" for="user_email">email</label>
        <input  class="fom-control" type="email" name="user_email" id="email" required>
        <div class ="invalidate-feedback"></div>
</div>

<div class="form-group was-validated">
        <label class="form-label" for="password">password</label>
        <input class="form-control" type="password" name="user_pass" id="pass" required>
        <div class ="invalidate-feedback"></div>
</div>
<div class="form-group form-check">
        <input class="form-check-input" type="checkbox" id="check">
        <label class="form-check-label" for="check">Se rappeler de moi</label>
</div>
