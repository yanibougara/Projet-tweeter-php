...
<?php foreach ($posts as $post) : ?>
  ...
  <div class="publication <?php echo $post['tag']; ?> tag-<?php echo $post['tag']; ?>" style="background-color:#73b9db;border-radius:10px;border:1px solid grey;font-family:IrishGrover;margin-left: 546px;">
